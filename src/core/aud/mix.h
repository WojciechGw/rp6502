 ...
 * and aud_stop stops whichever is registered, which is one of them: taking
 * either engine parks the other. The bell is not a device, so every mixer
 * adds it whatever this says.
